            ...
            <div className="flex items-center justify-center bg-background p-8">
                <div className="relative z-10 w-full max-w-[400px]">
                    ...
                    <div className="mb-8 text-center">
                        <h1 className="mb-1 text-2xl font-bold tracking-tight text-foreground">SISTRA-SAWIT</h1>
                        <p className="text-sm text-muted-foreground">Masukkan kredensial untuk mengakses dashboard</p>
                    </div>
                    ...
                    <form onSubmit={submit} className="space-y-5">
                        <div className="space-y-2">
                            ...
                            <Input
                                id="login"
                                type="text"
                                placeholder="admin@sistrasawit.com atau 0812..."
                                value={data.login}
